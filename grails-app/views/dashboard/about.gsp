...
<div id="aboutPage" class="page">
    <section class="py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Hero Story Section -->
            <!--                <div class="bg-gradient-to-br from-green-50 to-white rounded-2xl shadow-xl p-8 mb-12">-->
            <!--                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">-->
            <!--                        <div>-->
            <!--                            <h3 class="text-3xl font-bold text-green-800 mb-6">Our Story</h3>-->
            <!--                            <p class="text-gray-700 mb-6 leading-relaxed">-->
            <!--                                VISHWARAKSHA was born from a deep commitment to bringing the ancient wisdom of Ayurveda to modern hair care.-->
            <!--                                We believe that nature provides the best solutions for healthy, beautiful hair, and our products are crafted-->
            <!--                                with this philosophy at heart.-->
            <!--                            </p>-->
            <!--                            <p class="text-gray-700 mb-6 leading-relaxed">-->
            <!--                                Our journey began with the simple belief that chemical-free, natural products should be accessible to everyone.-->
            <!--                                Using traditional recipes passed down through generations, we create herbal formulations that nourish your hair-->
            <!--                                from root to tip.-->
            <!--                            </p>-->
            ...
            <!--                        </div>-->
            <!--                        <div class="relative">-->
            <!--                            <img src="https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=500&h=400&fit=crop" alt="Natural herbs" class="w-full h-80 object-cover rounded-xl shadow-lg">-->
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
                ...
                <div class="relative mt-2">
                    <img src="https://placehold.co/400" alt="Natural herbs"
